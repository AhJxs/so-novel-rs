...
[![Latest version](https://img.shields.io/crates/v/material_icons.svg)](https://crates.io/crates/material_icons)
[![Documentation](https://docs.rs/material_icons/badge.svg)](https://docs.rs/material_icons)
[![unsafe forbidden](https://img.shields.io/badge/unsafe-forbidden-success.svg)](https://github.com/rust-secure-code/safety-dance/)
[![License](https://img.shields.io/crates/l/material_icons.svg)](https://crates.io/crates/material_icons)
...
// later in some ui:
ui.button(material_icons::icons::ICON_ADD);
```
...
- **`outline`** - Include the outline font variant.
  ...
  ```rust
  use material_icons::icons::*;

  fn init(ctx: &egui::Context) {
    material_icons::initialize(ctx);
  }
